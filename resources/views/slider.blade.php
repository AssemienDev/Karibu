    ...
    <div  id="carouselExampleControls" data-bs-ride="carousel"
        ...
        <div  class="carousel-inner">
            <div  class="carousel-item active background_bg"
                data-img-src="{{ asset('images/banner1.png')}}"
            ...
            <div  class="carousel-item background_bg"
                data-img-src="{{ asset('images/banner7.png')}}"
                style="background-image: url(&quot;{{ asset('images/banner7.png')}}&quot;);">
                <div  class="banner_slide_content">
                    <div  class="container">
                        <div  class="row">
                            <div  class="col-lg-7 col-9">
            ...
            <div  class="carousel-item background_bg"
                data-img-src="{{ asset('images/banner5.png')}}"
                style="background-image: url(&quot;{{ asset('images/banner5.png')}}&quot;);">
                <div  class="banner_slide_content">
                    <div  class="container">
                        <div  class="row">
                            <div  class="col-lg-7 col-9">
